    ...
    <div class="flex-container">
        ...
        <div class="about_me">
          ...
          <h1>  <?php echo $p  ?> </h1>
            ...
            <div class="data">
                <div class="myImg">
                    <?php  echo '<img class="myyImg" src="img/5.png">'; ?>                    
                </div>

                <div class="fullname">
                    <p> Меня зовут 
                    <?php echo $name, ' ', $surname . '<br>'; 
                          echo 'город', ' ', $city, '<br><br>', 'Я обучаюсь в ', $edu; 
                          ?>                                      
                    </p> 
            ...
            <div class="knowledge">
                    ...
                    ?>   <br>                
                     <?php
                        echo $d;
                    ?> <br><br>
                    <?php echo "Делителем числа ", $num, " являются числа: ";
                    foreach ($arrDel as $row) {echo $row . ", ";}
                    ?>
